...
public interface MediaCompanyRepository extends JpaRepository<MediaCompany,Integer> {
    ...
    public List<MediaCompany> findByBothDate(@Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate);

    @Query("SELECT m FROM MediaCompany m WHERE m.createdAt > :startDate")
    public List<MediaCompany> findByStartDate(@Param("startDate") LocalDateTime startDate);

    @Query("SELECT m FROM MediaCompany m WHERE m.createdAt < :endDate")
    public List<MediaCompany> findByEndDate(@Param("endDate") LocalDateTime endDate);
