package com.example.reward_monitoring.statistics.saveMsn.daily.entity;
...
@Entity
@ToString
@Table(name = "save_msn_daily_stat")
public class SaveMsnDailyStat {
    @Id
    ...
    @Builder
    public SaveMsnDailyStat(MediaCompany mediaCompany, Advertiser advertiser, SaveMsn saveMsn
